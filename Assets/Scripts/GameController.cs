...
public class GameController : MonoBehaviour
{
    ...
    void SpawnEnemy()
    {
        spawnPositions = new Vector3(Random.Range(-bounds.x + 1f, bounds.x - 1f), bounds.y + Random.Range(0.25f, 3f), 0f);
        Instantiate(enemies[Random.Range(0, enemies.Length)], spawnPositions, Quaternion.Euler(0, 0, 180));
        spawnCools = Random.Range(timeBetweenSpawnLow, timeBetweenSpawnHigh);
    }
